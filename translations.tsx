...
export const translations: Record<Language, TranslationSet> = {
  RU: {
    header: { courses: "Курсы", why: "Почему мы", how: "Обучение", apply: "Личный кабинет", login: "Войти", logout: "Выйти", projects: "Проекты" },
    ...
    gallery: {
      titleTop: "Достижения наших студентов и",
      titleBottom: "СМИ о нас",
      description: "Яркие моменты и успехи из жизни нашего курса"
    }
  },
  UZ: {
    header: { courses: "Kurslar", why: "Nega biz", how: "O'qitish", apply: "Shaxsiy kabinet", login: "Kirish", logout: "Chiqish", projects: "Loyihalar" },
    ...
    gallery: {
      titleTop: "Talabalarimiz yutuqlari va",
      titleBottom: "OAV biz haqimizda",
      description: "Bizning kursimiz hayotidan yorqin lahzalar va yutuqlar"
    }
  },
  EN: {
    header: { courses: "Courses", why: "Why Us", how: "Learning", apply: "Student Portal", login: "Login", logout: "Logout", projects: "Projects" },
    ...
    gallery: {
      titleTop: "Our students' achievements and",
      titleBottom: "Media about us",
      description: "Bright moments and successes from our course life"
    }
  }
};
