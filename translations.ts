...
export const translations: Record<Language, TranslationSet> = {
  RU: {
    ...
    courses: {
      ...
      details: {
        ds: { duration: "9 месяцев", intensity: "3 раза в неделю", level: "Middle с нуля", program: ["Основы Python", "Математическая статистика", "Machine Learning", "Deep Learning", "SQL & Big Data", "Нейронные сети"], tools: ["Python", "Pandas", "PyTorch", "TensorFlow", "PostgreSQL", "Jupyter"], result: "Портфолио из 5 реальных кейсов и диплом специалиста." },
  ...
  UZ: {
    ...
    courses: {
      ...
      modalLabels: { program: "Kurs dasturi", tools: "Asboblar", result: "O'qish natijasi", cta: "Kursga yozilish", spots: "* Guruhlar 15 kishigacha" },
      details: {
        ds: { duration: "9 oy", intensity: "Haftada 3 marta", level: "Noldan Middle", program: ["Python asoslari", "Matematik statistika", "Machine Learning", "Deep Learning", "SQL & Big Data", "Neyron tarmoqlar"], tools: ["Python", "Pandas", "PyTorch", "TensorFlow", "PostgreSQL", "Jupyter"], result: "5 ta real loyihadan iborat portfoliyo va mutaxassis diplomi." },
  ...
  EN: {
    ...
    courses: {
      ...
      details: {
        ds: { duration: "9 months", intensity: "3 times a week", level: "Zero to Middle", program: ["Python Basics", "Mathematical Statistics", "Machine Learning", "Deep Learning", "SQL & Big Data", "Neural Networks"], tools: ["Python", "Pandas", "PyTorch", "TensorFlow", "PostgreSQL", "Jupyter"], result: "Portfolio of 5 real cases and a specialist diploma." },
